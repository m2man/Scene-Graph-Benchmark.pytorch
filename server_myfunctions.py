...
with open('/home/nmduy/Scene-Graph-Benchmark.pytorch/datasets/vg/VG-SGG-dicts-with-attri.json', 'r') as f:
...
# ======== OLD ========= #
# def decode_relation_v0(pair_array, rel_label_array, label_array, info_dict):
...
# def decode_relation_human_read(boxlist, info_dict, show_scores=False):
#     # show_score will show the sgg_score: average score for sub - pred - obj
#     pair_array = boxlist.get_field('rel_pair_idxs')
#     rel_label_array = boxlist.get_field('pred_rel_labels')
#     label_array = boxlist.get_field('pred_labels')
